...
!function (t, i) {
    if ("object" == typeof exports && "object" == typeof module) module.exports = i(require("Raphael")); else if ("function" == typeof define && define.amd) define(["Raphael"], i); else {
    ...
    return function (t) {
        ...
        function r(t, i, e) {
            ...
            var r = this.getAttr("font"), s = this.getAttr("font-family"), o = this.getAttr("font-weight");
            r && this.text.attr({ font: r }), s && this.text.attr({ "font-family": s }), o && this.text.attr({ "font-weight": o }), i.link && this.text.attr("href", i.link), i.target && this.text.attr("target", i.target);
            var h = this.getAttr("maxWidth");
            if (h) {
                for (var n = i.text.split(" "), a = "", l = 0, p = n.length; l < p; l++) {
                    var y = n[l];
                    this.text.attr("text", a + " " + y), a += this.text.getBBox().width > h ? "\n" + y : " " + y
                }
                this.text.attr("text", a.substring(1))
            }
            if (this.group.push(this.text), e) {
                var x = this.getAttr("text-margin");
                e.attr({
                    fill: this.getAttr("fill"),
                    stroke: this.getAttr("element-color"),
                    "stroke-width": this.getAttr("line-width"),
                    width: this.text.getBBox().width + 2 * x,
                    height: this.text.getBBox().height + 2 * x
                }), e.node.setAttribute("class", this.getAttr("class")), i.link && e.attr("href", i.link), i.target && e.attr("target", i.target), i.key && (e.node.id = i.key), this.group.push(e), e.insertBefore(this.text), this.text.attr({ y: e.getBBox().height / 2 }), this.initialize()
            }
        }

        var s = e(3), o = s.drawLine, h = s.checkLineIntersection;
        r.prototype.getAttr = function (t) {
            ...
            var t = this.getY(), i = this.getX() + this.width / 2;
            return { x: i, y: t }
        }, r.prototype.getBottom = function () {
            var t = this.getY() + this.height, i = this.getX() + this.width / 2;
            return { x: i, y: t }
        }, r.prototype.getLeft = function () {
            var t = this.getY() + this.group.getBBox().height / 2, i = this.getX();
            return { x: i, y: t }
        }, r.prototype.getRight = function () {
            var t = this.getY() + this.group.getBBox().height / 2, i = this.getX() + this.group.getBBox().width;
            return { x: i, y: t }
        }, r.prototype.render = function () {
            if (this.next) {
                var t = this, i = this.getAttr("line-length");
                if ("right" === this.next_direction) {
                    ...
                    this.next.isPositioned || (this.next.setY(e.y - this.next.height / 2), this.next.shiftX(this.group.getBBox().x + this.width + i), function e() {
                        ...
                        if (s) {
                            if ("end" === t.next.symbolType) return;
                            t.next.setX(r.getX() + r.width + i), e()
                        }
            ...
            var r, s = this.getCenter().x, n = this.getCenter().y, a = this.getRight(), l = this.getBottom(),
                p = this.getTop(), y = this.getLeft(), x = t.getCenter().x, g = t.getCenter().y, c = t.getTop(),
                f = t.getRight(), d = t.getLeft(), m = s === x, u = n === g, b = n < g, _ = n > g || this === t,
                v = s > x, w = s < x, k = 0, B = this.getAttr("line-length"), A = this.getAttr("line-width");
            if (e && "bottom" !== e || !m || !b) if (e && "right" !== e || !u || !w) if (e && "left" !== e || !u || !v) if (e && "right" !== e || !m || !_) if (e && "right" !== e || !m || !b) if (e && "bottom" !== e || !v) if (e && "bottom" !== e || !w || !b) if (e && "bottom" !== e || !w) if (e && "right" === e && v) r = o(this.chart, a, [{
                x: a.x + B / 2,
                y: a.y
            }, { x: a.x + B / 2, y: c.y - B / 2 }, { x: c.x, y: c.y - B / 2 }, {
                x: c.x,
                y: c.y
            }], i), this.rightStart = !0, t.topEnd = !0, k = a.x + B / 2; else if (e && "right" === e && w) r = o(this.chart, a, [{
                x: c.x,
                y: a.y
            }, {
                x: c.x,
                y: c.y
            }], i), this.rightStart = !0, t.topEnd = !0, k = a.x + B / 2; else if (e && "bottom" === e && m && _) r = o(this.chart, l, [{
                x: l.x,
                y: l.y + B / 2
            }, { x: a.x + B / 2, y: l.y + B / 2 }, { x: a.x + B / 2, y: c.y - B / 2 }, {
                x: c.x,
                y: c.y - B / 2
            }, {
                x: c.x,
                y: c.y
            }], i), this.bottomStart = !0, t.topEnd = !0, k = l.x + B / 2; else if ("left" === e && m && _) {
                var X = y.x - B / 2;
                d.x < y.x && (X = d.x - B / 2), r = o(this.chart, y, [{ x: X, y: y.y }, {
                    x: X,
                    y: c.y - B / 2
                }, { x: c.x, y: c.y - B / 2 }, { x: c.x, y: c.y }], i), this.leftStart = !0, t.topEnd = !0, k = y.x
            } else "left" === e ? (r = o(this.chart, y, [{
                x: c.x + (y.x - c.x) / 2,
                y: y.y
            }, { x: c.x + (y.x - c.x) / 2, y: c.y - B / 2 }, { x: c.x, y: c.y - B / 2 }, {
                x: c.x,
                y: c.y
            }], i), this.leftStart = !0, t.topEnd = !0, k = y.x) : "top" === e && (r = o(this.chart, p, [{
                x: p.x,
                y: c.y - B / 2
            }, { x: c.x, y: c.y - B / 2 }, {
                x: c.x,
                y: c.y
            }], i), this.topStart = !0, t.topEnd = !0, k = p.x); else r = o(this.chart, l, [{
                x: l.x,
                y: l.y + B / 2
            }, { x: l.x + (l.x - c.x) / 2, y: l.y + B / 2 }, { x: l.x + (l.x - c.x) / 2, y: c.y - B / 2 }, {
                x: c.x,
                y: c.y - B / 2
            }, {
                x: c.x,
                y: c.y
            }], i), this.bottomStart = !0, t.topEnd = !0, k = l.x + (l.x - c.x) / 2; else r = o(this.chart, l, [{
                x: l.x,
                y: c.y - B / 2
            }, { x: c.x, y: c.y - B / 2 }, {
                x: c.x,
                y: c.y
            }], i), this.bottomStart = !0, t.topEnd = !0, k = l.x, c.x > k && (k = c.x); else r = this.leftEnd && _ ? o(this.chart, l, [{
                x: l.x,
                y: l.y + B / 2
            }, { x: l.x + (l.x - c.x) / 2, y: l.y + B / 2 }, { x: l.x + (l.x - c.x) / 2, y: c.y - B / 2 }, {
                x: c.x,
                y: c.y - B / 2
            }, { x: c.x, y: c.y }], i) : o(this.chart, l, [{ x: l.x, y: c.y - B / 2 }, {
                x: c.x,
                y: c.y - B / 2
            }, {
                x: c.x,
                y: c.y
            }], i), this.bottomStart = !0, t.topEnd = !0, k = l.x + (l.x - c.x) / 2; else r = o(this.chart, a, [{
                x: a.x + B / 2,
                y: a.y
            }, { x: a.x + B / 2, y: c.y - B / 2 }, { x: c.x, y: c.y - B / 2 }, {
                x: c.x,
                y: c.y
            }], i), this.rightStart = !0, t.topEnd = !0, k = a.x + B / 2; else r = o(this.chart, a, [{
                x: a.x + B / 2,
                y: a.y
            }, { x: a.x + B / 2, y: c.y - B / 2 }, { x: c.x, y: c.y - B / 2 }, {
                x: c.x,
                y: c.y
            }], i), this.rightStart = !0, t.topEnd = !0, k = a.x + B / 2; else r = o(this.chart, y, f, i), this.leftStart = !0, t.rightEnd = !0, k = f.x; else r = o(this.chart, a, d, i), this.rightStart = !0, t.leftEnd = !0, k = d.x; else r = o(this.chart, l, c, i), this.bottomStart = !0, t.topEnd = !0, k = l.x;
            if (this.lineStyle[t.key] && r && r.attr(this.lineStyle[t.key]), r) {
                for (var O = 0, L = this.chart.lines.length; O < L; O++) for (var M, T = this.chart.lines[O], S = T.attr("path"), C = r.attr("path"), Y = 0, P = S.length - 1; Y < P; Y++) {
                    var E = [];
                    E.push(["M", S[Y][1], S[Y][2]]), E.push(["L", S[Y + 1][1], S[Y + 1][2]]);
                    for (var j = E[0][1], z = E[0][2], R = E[1][1], F = E[1][2], I = 0, N = C.length - 1; I < N; I++) {
                        var W = [];
                        W.push(["M", C[I][1], C[I][2]]), W.push(["L", C[I + 1][1], C[I + 1][2]]);
                        var V = W[0][1], q = W[0][2], G = W[1][1], Q = W[1][2], J = h(j, z, R, F, V, q, G, Q);
                        if (J.onLine1 && J.onLine2) {
                            var $;
                            q === Q ? V > G ? ($ = ["L", J.x + 2 * A, q], C.splice(I + 1, 0, $), $ = ["C", J.x + 2 * A, q, J.x, q - 4 * A, J.x - 2 * A, q], C.splice(I + 2, 0, $), r.attr("path", C)) : ($ = ["L", J.x - 2 * A, q], C.splice(I + 1, 0, $), $ = ["C", J.x - 2 * A, q, J.x, q - 4 * A, J.x + 2 * A, q], C.splice(I + 2, 0, $), r.attr("path", C)) : q > Q ? ($ = ["L", V, J.y + 2 * A], C.splice(I + 1, 0, $), $ = ["C", V, J.y + 2 * A, V + 4 * A, J.y, V, J.y - 2 * A], C.splice(I + 2, 0, $), r.attr("path", C)) : ($ = ["L", V, J.y - 2 * A], C.splice(I + 1, 0, $), $ = ["C", V, J.y - 2 * A, V + 4 * A, J.y, V, J.y + 2 * A], C.splice(I + 2, 0, $), r.attr("path", C)), I += 2, M += 2
                        }
                    }
                }
                this.chart.lines.push(r), (void 0 === this.chart.minXFromSymbols || this.chart.minXFromSymbols > y.x) && (this.chart.minXFromSymbols = y.x)
            }
        ...
        function e(t, i, e) {
            ...
            var a = t.options.font, l = t.options["font-family"], p = t.options["font-weight"];
            return a && n.attr({ font: a }), l && n.attr({ "font-family": l }), p && n.attr({ "font-weight": p }), n
        }
        ...
        function r(t, i, e, r) {
            ...
            var l = t.options.font, p = t.options["font-family"], y = t.options["font-weight"];
            if (l && a.attr({ font: l }), p && a.attr({ "font-family": p }), y && a.attr({ "font-weight": y }), r) {
                var x = !1, g = t.paper.text(0, 0, r), c = !1, f = e[0];
                i.y === f.y && (c = !0);
                var d = 0, m = 0;
                x ? (d = i.x > f.x ? i.x - (i.x - f.x) / 2 : f.x - (f.x - i.x) / 2, m = i.y > f.y ? i.y - (i.y - f.y) / 2 : f.y - (f.y - i.y) / 2, c ? (d -= g.getBBox().width / 2, m -= t.options["text-margin"]) : (d += t.options["text-margin"], m -= g.getBBox().height / 2)) : (d = i.x, m = i.y, c ? (d += t.options["text-margin"] / 2, m -= t.options["text-margin"]) : (d += t.options["text-margin"] / 2, m += t.options["text-margin"], i.y > f.y && (m -= 2 * t.options["text-margin"]))), g.attr({
                    "text-anchor": "start",
                    "font-size": t.options["font-size"],
                    fill: t.options["font-color"],
                    x: d,
                    y: m
                }), l && g.attr({ font: l }), p && g.attr({ "font-family": p }), y && g.attr({ "font-weight": y })
            }
            return a
        }

        function s(t, i, e, r, s, o, h, n) {
            var a, l, p, y, x, g = { x: null, y: null, onLine1: !1, onLine2: !1 };
            return a = (n - o) * (e - t) - (h - s) * (r - i), 0 === a ? g : (l = i - o, p = t - s, y = (h - s) * l - (n - o) * p, x = (e - t) * l - (r - i) * p, l = y / a, p = x / a, g.x = t + l * (e - t), g.y = i + l * (r - i), l > 0 && l < 1 && (g.onLine1 = !0), p > 0 && p < 1 && (g.onLine2 = !0), g)
        }
        ...
        function r(t) {
            ...
            function x(t) {
                var i = "next", e = t.indexOf("(") + 1, r = t.indexOf(")");
                return e >= 0 && r >= 0 && (i = E.substring(e, r), i.indexOf(",") < 0 && "yes" !== i && "no" !== i && (i = "next, " + i)), i
            }

            t = t || "", t = t.trim();
            for (var g = {
                symbols: {}, start: null, drawSVG: function (t, i) {
                    function e(t) {
                    ...
                    !function t(i, s, o) {
                        var h = e(i);
                        return r.start === i ? x.startWith(h) : s && o && !s.pathOk && (s instanceof p ? (o.yes === i && s.yes(h), o.no === i && s.no(h)) : s instanceof y ? (o.path1 === i && s.path1(h), o.path2 === i && s.path2(h), o.path3 === i && s.path3(h)) : s.then(h)), h.pathOk ? h : (h instanceof p ? (i.yes && t(i.yes, h, i), i.no && t(i.no, h, i)) : h instanceof y ? (i.path1 && t(i.path1, h, i), i.path2 && t(i.path2, h, i), i.path3 && t(i.path3, h, i)) : i.next && t(i.next, h, i), h)
                    }(this.start), x.render()
                }, clean: function () {
                    this.diagram.clean()
                }
            }, c = [], f = 0, d = 1, m = t.length; d < m; d++) if ("\n" === t[d] && "\\" !== t[d - 1]) {
            ...
            for (; c.length > 0;) {
                ...
                if (w.indexOf("=>") >= 0) {
                    ...
                    if (A && A.length > 1) for (var X = A[1].split(","), O = 0; O < X.length; O++) {
                        var L = X[0].split("=");
                    ...
                    if (B.symbolType.indexOf(": ") >= 0 && (M = B.symbolType.split(": "), B.symbolType = M.shift(), B.text = M.join(": ")), B.text && B.text.indexOf(":>") >= 0 ? (M = B.text.split(":>"), B.text = M.shift(), B.link = M.join(":>")) : B.symbolType.indexOf(":>") >= 0 && (M = B.symbolType.split(":>"), B.symbolType = M.shift(), B.link = M.join(":>")), B.symbolType.indexOf("\n") >= 0 && (B.symbolType = B.symbolType.split("\n")[0]), B.link) {
                        var T = B.link.indexOf("[") + 1, S = B.link.indexOf("]");
                        T >= 0 && S >= 0 && (B.target = B.link.substring(T, S), B.link = B.link.substring(0, T - 1))
                    }
                    // if (B.text && B.text.indexOf("|") >= 0) {
                    //     var C = B.text.split("|");
                    //     B.flowstate = C.pop().trim(), B.text = C.join("|")
                    // }
                    g.symbols[B.key] = B
                } else if (w.indexOf("->") >= 0) for (var Y = w.split("->"), O = 0, P = Y.length; O < P; O++) {
                    var E = Y[O], j = e(E);
                    "true" !== j && "false" !== j || (E = E.replace("true", "yes"), E = E.replace("false", "no"));
                    var z = r(E), R = x(E), F = null;
                    if (R.indexOf(",") >= 0) {
                        var I = R.split(",");
                        R = I[0], F = I[1].trim()
                    }
                ...
                } else if (w.indexOf("@>") >= 0) for (var W = w.split("@>"), O = 0, P = W.length; O < P; O++) if (O + 1 != P) {
                    var V = r(W[O]), N = r(W[O + 1]);
        ...
        o(r, s), r.prototype.render = function () {
            ...
            if (this.right_symbol) {
                ...
                if (!this.right_symbol.isPositioned) {
                    ...
                    var r = this;
                    !function i() {
                        for (var e, s = !1, o = 0, h = r.chart.symbols.length; o < h; o++) if (e = r.chart.symbols[o], !r.params["align-next"] || "no" !== r.params["align-next"]) {
                        ...
                        if (s) {
                            if ("end" === r.right_symbol.symbolType) return;
                            r.right_symbol.setX(e.getX() + e.width + t), i()
                        }
        ...
        o(r, s), r.prototype.render = function () {
            ...
            if (this.left_symbol) {
                ...
                this.left_symbol.isPositioned || (this.left_symbol.setY(s.y - this.left_symbol.height / 2), this.left_symbol.shiftX(-(this.group.getBBox().x + this.width + t)), function i() {
                    ...
                    if (s) {
                        if ("end" === r.left_symbol.symbolType) return;
                        r.left_symbol.setX(e.getX() + e.width + t), i()
                    }
        ...
        var s = e(16), o = e(1).defaults, h = e(8), n = e(5), a = e(6);
        r.prototype.handle = function (t) {
            ...
            var t, i, e = 0, r = 0, s = 0, o = 0, h = 0, n = 0, a = 0, l = 0;
            ...
            h = this.maxXFromLine;
            var p, y;
            for (s = 0, o = this.symbols.length; s < o; s++) t = this.symbols[s], p = t.getX() + t.width, y = t.getY() + t.height, p > h && (h = p), y > n && (n = y);
            for (s = 0, o = this.lines.length; s < o; s++) {
                i = this.lines[s].getBBox(), p = i.x, y = i.y;
                var x = i.x2, g = i.y2;
                p < a && (a = p), y < l && (l = y), x > h && (h = x), g > n && (n = g)
            }
            var c = this.options.scale, f = this.options["line-width"];
        ...
        t.exports = {
            ...
            class: "flowchart",
            scale: 1,
            symbols: { start: {}, end: {}, condition: {}, inputoutput: {}, operation: {}, subroutine: {}, parallel: {} }
        }
    }, function (t, i) {
        Array.prototype.indexOf || (Array.prototype.indexOf = function (t) {
            ...
            for (var s = r >= 0 ? r : Math.max(e - Math.abs(r), 0); s < e; s++) if (s in i && i[s] === t) return s;
            return -1
            ...
            for (var s = r >= 0 ? Math.min(r, e - 1) : e - Math.abs(r); s >= 0; s--) if (s in i && i[s] === t) return s;
            return -1
        ...
        function r(t, i) {
            i = i || {}, s.call(this, t, i), this.textMargin = this.getAttr("text-margin"), this.text.attr({ x: 3 * this.textMargin });
            var e = this.text.getBBox().width + 4 * this.textMargin,
                r = this.text.getBBox().height + 2 * this.textMargin, o = this.textMargin, h = r / 2,
                a = { x: o, y: h }, l = [{ x: o - this.textMargin, y: r }, {
                    x: o - this.textMargin + e,
                    y: r
                }, {
                    x: o - this.textMargin + e + 2 * this.textMargin,
                    y: 0
                }, { x: o - this.textMargin + 2 * this.textMargin, y: 0 }, { x: o, y: h }], p = n(t, a, l);
            p.attr({
                stroke: this.getAttr("element-color"),
                "stroke-width": this.getAttr("line-width"),
                fill: this.getAttr("fill")
        ...
        o(r, s), r.prototype.getLeft = function () {
            var t = this.getY() + this.group.getBBox().height / 2, i = this.getX() + this.textMargin;
            return { x: i, y: t }
        }, r.prototype.getRight = function () {
        ...
        function r(t, i) {
            var e = t.paper.rect(0, 0, 0, 0);
            i = i || {}, s.call(this, t, i, e), e.attr({ width: this.text.getBBox().width + 4 * this.getAttr("text-margin") }), this.text.attr({ x: 2 * this.getAttr("text-margin") });
            ...
            var o = this.getAttr("font"), h = this.getAttr("font-family"), n = this.getAttr("font-weight");
            o && r.attr({ font: o }), h && r.attr({ "font-family": h }), n && r.attr({ "font-weight": n }), i.link && r.attr("href", i.link), i.target && r.attr("target", i.target), this.group.push(r), r.insertBefore(this.text), this.initialize()
        }
...
//# sourceMappingURL=flowchart_makai.min.js.map